...
!
!   flat_int(range)  returns an integer from a flat distribution(0, 1, .. range]
...
!  ran (idum):  returns a random number from a uniform distribution (0..1]
...
!**********************************************************************
! ran:  generates random values 0..1] 
!  From Press et al.,(2003) Numerical recipes in FORTRAN (2nd ed.) CUP 
!**********************************************************************
...
function geometric(p_success)
 ...
 rn = ran(idum)                     ! get random probability value
...
!**********************************************************************
! flat_int :  returns an integer from a flat probability distribution
! parameter:  range
!**********************************************************************
function flat_int(range)
 integer              :: flat_int
 integer, intent(in)  :: range
 
 !flat_int = int(ran3(idum) * range) + 1
 flat_int = int(ran(idum) * range) + 1
 return
end function flat_int 
